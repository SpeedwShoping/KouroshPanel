// Package config provides configuration management utilities for the Kourosh panel,
...
// GetBaseVersion returns the raw embedded release version of the Kourosh panel
...
// GetName returns the name of the Kourosh application.
func GetName() string {
...
func GetLogFolder() string {
	...
	if testing.Testing() {
		return filepath.Join(os.TempDir(), "Kourosh-test-log")
	}
	if runtime.GOOS == "windows" {
		return filepath.Join(".", "log")
	}
	return "/var/log/kourosh"
}
