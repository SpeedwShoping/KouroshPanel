...
// previous kourosh run and returns how many were killed.
//
// kourosh starts one mtg process per mtproto inbound outside its own lifecycle, and
...
// domain-fronted to the FakeTLS domain instead of proxied to Telegram. kourosh is
