// Package web provides the main web server implementation for the Kourosh panel,
...
import (
	...
	"github.com/SpeedwShoping/KouroshPanel/internal/web/controller"
	"github.com/SpeedwShoping/KouroshPanel/internal/web/job"
	"github.com/SpeedwShoping/KouroshPanel/internal/web/locale"
	"github.com/SpeedwShoping/KouroshPanel/internal/web/middleware"
	"github.com/SpeedwShoping/KouroshPanel/internal/web/network"
...
// Server represents the main web server for the Kourosh panel with controllers, services, and scheduled jobs.
type Server struct {
...
func (s *Server) initRouter() (*gin.Engine, error) {
	...
	engine.Use(sessions.Sessions("Kourosh", store))
...
func (s *Server) start(restartXray bool, startTgBot bool) (err error) {
	...
	controller.SetTestTgFunc(func() error {
		...
		s.tgbotService.SendMsgToTgbotAdmins("✅ Test message from Kourosh")
		return nil
	})
