// Package model defines the database models and data structures used by the Kourosh panel.
package model
...
// User represents a user account in the Kourosh panel.
type User struct {
...
// Setting stores key-value configuration settings for the Kourosh panel.
type Setting struct {
	Id    int    `json:"id" form:"id" gorm:"primaryKey;autoIncrement"`
...
// Node represents a remote Kourosh panel registered with the central panel.
