// Package logger provides logging functionality for the Kourosh panel with
...
const (
	...
	logFileName      = "kourosh.log"            // Log file name
...
var (
	...
	logger     = logging.MustGetLogger("kourosh")
...
func InitLogger(level logging.Level) {
	newLogger := logging.MustGetLogger("kourosh")
	...
	leveledBackend.SetLevel(level, "kourosh")
	...
	if fileBackend := initFileBackend(); fileBackend != nil {
		...
		leveledBackend.SetLevel(logging.DEBUG, "kourosh")
		backends = append(backends, leveledBackend)
	}
