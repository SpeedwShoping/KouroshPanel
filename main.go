// Package main is the entry point for the Kourosh web panel application.
...
import (
	...
	"github.com/SpeedwShoping/KouroshPanel/internal/sub"
	"github.com/SpeedwShoping/KouroshPanel/internal/tunnelmonitor"
	"github.com/SpeedwShoping/KouroshPanel/internal/util/crypto"
	"github.com/SpeedwShoping/KouroshPanel/internal/util/sys"
	"github.com/SpeedwShoping/KouroshPanel/internal/web"
...
// runWebServer initializes and starts the web server for the Kourosh panel.
func runWebServer() {
...
// migrateDb performs database migration operations for the Kourosh panel.
func migrateDb() {
...
// "kourosh setting" hit the same database backend as the panel. godotenv.Load does
...
// main is the entry point of the Kourosh application.
...
func main() {
	...
	migrateDbCmd.StringVar(&migrateSrc, "src", "", "Source SQLite file (defaults to the configured kourosh.db)")
	...
	flag.Usage = func() {
		...
		fmt.Println("    migrate        migrate form other/old kourosh")
